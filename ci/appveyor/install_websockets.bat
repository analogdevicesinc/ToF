...
pushd %build_dir%
cmake -DLWS_WITH_SSL=OFF -DLWS_WITHOUT_TESTAPPS=ON -DLWS_WITHOUT_TEST_SERVER=ON -DLWS_WITH_SHARED=ON -DLWS_WITH_STATIC=OFF PREFIX="./local_path/websockets" -G "%generator%" -A "%arch%" ..
