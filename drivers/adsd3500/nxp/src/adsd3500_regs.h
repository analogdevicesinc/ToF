...
#define SET_IMAGER_MODE_AB_AVG_EN(x)                                           \
    FIELD_PREP(SET_IMAGER_MODE_AB_AVG_EN_MSK, x)
#define SET_IMAGER_MODE_DEPTH_BITS_MSK GENMASK(6, 4)
#define SET_IMAGER_MODE_DEPTH_BITS(x)                                          \
    FIELD_PREP(SET_IMAGER_MODE_DEPTH_BITS_MSK, x)
...
#define SET_IMAGER_MODE_CONF_BITS(x)                                           \
    FIELD_PREP(SET_IMAGER_MODE_CONF_BITS_MSK, x)
#define SET_IMAGER_MODE_MIPI_LANES_NR_MSK GENMASK(13, 12)
#define SET_IMAGER_MODE_MIPI_LANES_NR(x)                                       \
    FIELD_PREP(SET_IMAGER_MODE_MIPI_LANES_NR_MSK, x)
