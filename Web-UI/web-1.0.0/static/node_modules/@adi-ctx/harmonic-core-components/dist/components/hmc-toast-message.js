...
const HmcToastMessage$1 = /*@__PURE__*/ proxyCustomElement(class HmcToastMessage extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.actionClicked = createEvent(this, "actionClicked", 7);
    this.toastClosing = createEvent(this, "toastClosing", 7);
...
function defineCustomElement$1() {
  ...
  const components = ["hmc-toast-message", "hmc-button", "hmc-icon", "hmc-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "hmc-toast-message":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HmcToastMessage$1);
      }
      break;
    case "hmc-button":
      if (!customElements.get(tagName)) {
...
const HmcToastMessage = HmcToastMessage$1;
const defineCustomElement = defineCustomElement$1;

export { HmcToastMessage, defineCustomElement };
