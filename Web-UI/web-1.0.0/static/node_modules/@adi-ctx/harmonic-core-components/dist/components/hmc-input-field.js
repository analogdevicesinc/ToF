...
const HmcInputField$1 = /*@__PURE__*/ proxyCustomElement(class HmcInputField extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return inputFieldCss; }
}, [1, "hmc-input-field", {
    "name": [1],
    "value": [1025],
    "label": [1],
    ...
    "isAutoFocused": [4, "autofocus"],
    "autoComplete": [1, "autocomplete"],
    "hasSpellcheck": [1, "spellcheck"],
    "enterKeyHint": [1, "enterkeyhint"],
...
function defineCustomElement$1() {
  ...
  const components = ["hmc-input-field", "hmc-icon", "hmc-message"];
  components.forEach(tagName => { switch (tagName) {
    case "hmc-input-field":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HmcInputField$1);
      }
      break;
    case "hmc-icon":
      if (!customElements.get(tagName)) {
...
const HmcInputField = HmcInputField$1;
const defineCustomElement = defineCustomElement$1;

export { HmcInputField, defineCustomElement };
