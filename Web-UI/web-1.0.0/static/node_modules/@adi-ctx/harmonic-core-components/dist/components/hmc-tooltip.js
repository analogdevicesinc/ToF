...
import { c as createPopper, f as flip, o as offset } from './popper-lite.js';
...
const HmcTooltip$1 = /*@__PURE__*/ proxyCustomElement(class HmcTooltip extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return tooltipCss; }
    ...
    "placement": [1],
    "toggleTitle": [1, "toggle-title"],
    "isOpen": [4, "open"],
    "isFixedWidth": [4, "fixed-width"],
    "isToggle": [4, "toggle"],
    "size": [1]
  }, [[4, "keydown", "closeTooltip"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["hmc-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "hmc-tooltip":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HmcTooltip$1);
      }
      break;
  } });
}

const HmcTooltip = HmcTooltip$1;
const defineCustomElement = defineCustomElement$1;

export { HmcTooltip, defineCustomElement };
