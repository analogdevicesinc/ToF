...
const HmcDropdownMenu$1 = /*@__PURE__*/ proxyCustomElement(class HmcDropdownMenu extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  const components = ["hmc-dropdown-menu"];
  components.forEach(tagName => { switch (tagName) {
    case "hmc-dropdown-menu":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HmcDropdownMenu$1);
      }
      break;
  } });
}

const HmcDropdownMenu = HmcDropdownMenu$1;
const defineCustomElement = defineCustomElement$1;

export { HmcDropdownMenu, defineCustomElement };
