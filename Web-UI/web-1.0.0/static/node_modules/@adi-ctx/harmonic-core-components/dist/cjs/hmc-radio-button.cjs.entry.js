...
const HmcRadioButton = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onClick: this.onClick, role: "radio", tabindex: buttonTabindex, class: { 'radio-disabled': isDisabled } }, index.h("div", { class: "container" }, index.h("div", { class: radioClassList }, index.h("div", { class: "radio-inner" })), index.h("label", { htmlFor: inputId, class: labelClass }, label, index.h("span", { class: "hint" }, index.h("slot", { name: "hint" })))), index.h("input", { type: "radio", checked: isChecked, disabled: isDisabled, tabindex: "-1", id: inputId, ref: nativeEl => (this.nativeInput = nativeEl) })));
  }
  get el() { return index.getElement(this); }
};
let radioButtonIds = 0;
HmcRadioButton.style = radioButtonCss;

exports.hmc_radio_button = HmcRadioButton;
