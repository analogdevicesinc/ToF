...
const HmcChip = class {
  ...
  render() {
    ...
    const content = (index.h("div", { class: "content-wrapper" }, hasCheckmark && isSelected && (index.h("hmc-icon", { name: `check-${size === 'xs' ? 's' : 'm'}` })), index.h("slot", { name: "icon" }), index.h("div", { class: "text-wrapper" }, index.h("slot", null))));
    const chip = (index.h("button", { "aria-pressed": isSelected.toString(), class: chipClasses, onClick: () => this.clickHandler(), disabled: isDisabled, autoFocus: autofocus }, content));
    return index.h(index.Host, { class: classList }, chip);
  }
  get el() { return index.getElement(this); }
};
HmcChip.style = chipCss;

exports.hmc_chip = HmcChip;
