...
const HmcToggle = class {
  ...
  render() {
    ...
    utils.renderHiddenInput(this.el, name, isDisabled, isChecked ? value : '');
    return (index.h(index.Host, { onFocusin: () => this.setFocus(), class: {
        'disabled': isDisabled,
        'full-width': isFullWidth,
      }, "aria-checked": `${isChecked}`, role: "switch", tabindex: isDisabled ? -1 : 0 }, index.h("div", { class: containerClass }, label && (index.h("label", { htmlFor: "hmc-toggle", class: labelClass }, label)), index.h("div", { onClick: this.onClick, class: toggleClass }, index.h("div", { class: "toggle-inner" })), index.h("input", { type: "checkbox", role: "switch", "aria-checked": `${isChecked}`, disabled: isDisabled, id: 'hmc-toggle', tabindex: "-1", onClick: e => {
        this.onClick(e);
      }, onBlur: () => {
        this._focused = false;
      }, ref: el => {
...
HmcToggle.style = toggleCss;

exports.hmc_toggle = HmcToggle;
