...
const HmcDropdown = class {
  ...
  render() {
    ...
    utils.renderHiddenInput(this.el, name, isDisabled, this.getText());
    ...
    return (index.h(index.Host, null, index.h("div", { class: 'input-label ' + size }, !!label && (index.h("span", { class: "label" }, index.h("label", { htmlFor: FIELD_ID }, label), index.h("span", { class: "hint" }, index.h("slot", { name: "hint" })))), isRequired === false && (index.h("span", { class: "label-optional" }, optionalText))), index.h("button", { class: inputClasses, "aria-haspopup": "listbox", disabled: isDisabled }, index.h("div", { class: selectedValueClasses }, index.h("slot", { name: "icon" }), index.h("div", { class: "dropdown-text" }, value ? this.getText() : placeholder)), index.h("hmc-icon", { class: "dropdown-arrow", name: "chevron-down-m" })), index.h("div", { role: "listbox", class: listContainerClasses }, index.h("slot", null)), status !== 'normal' && Boolean(helperText) && (index.h("div", { class: "helper-text" }, index.h("hmc-message", { status: status }, helperText)))));
  }
  getText() {
...
exports.hmc_dropdown = HmcDropdown;
