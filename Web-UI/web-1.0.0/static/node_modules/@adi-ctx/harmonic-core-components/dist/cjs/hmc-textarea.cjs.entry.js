...
const HmcTextarea = class {
  constructor(hostRef) {
    ...
    this.hmcInput = index.createEvent(this, "hmcInput", 7);
    this.hmcChange = index.createEvent(this, "hmcChange", 7);
    this.hmcBlur = index.createEvent(this, "hmcBlur", 7);
    this.hmcFocus = index.createEvent(this, "hmcFocus", 7);
    this.onBlur = event => {
  ...
  render() {
    ...
    return (index.h(index.Host, { ref: ref => (this.rootEl = ref), class: fullWidth }, index.h("div", { class: wrapperClassList }, index.h("div", { class: "textarea-label" }, !!label && (index.h("span", { class: "label" }, index.h("label", { htmlFor: FIELD_ID }, label), index.h("span", { class: "hint" }, index.h("slot", { name: "hint" })))), isRequired === false && (index.h("span", { class: "label-optional" }, optionalText))), inputGroup, index.h("div", { class: "bottom-text" }, ' ', status !== 'normal' && Boolean(helperText) && (index.h("div", { class: "helper-text" }, index.h("hmc-message", { status: status }, helperText))), hasCounter === true && (index.h("div", { class: "counter" }, this.value.toString().length, maxLength > 0 ? `/${maxLength}` : ''))))));
  }
...
exports.hmc_textarea = HmcTextarea;
