...
const HmcProgressBar = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "progressbar", "aria-valuenow": indeterminate ? null : value, "aria-valuemin": "0", "aria-valuemax": maxValue }, index.h("div", { class: "progress-bar" }, index.h("div", { class: "content" }, this.label && index.h("div", { class: labelClass }, this.label), index.h("div", { class: "right" }, this.showPercentage && (index.h("div", { class: valueClass }, Math.floor(scaledValue * 100), "%")), index.h("slot", { name: "action-button" }))), index.h("div", { class: barClass }, index.h("div", { class: indicatorClass, style: {
        transform: `scaleX(${indeterminate ? 1 : scaledValue})`,
      } }), index.h("div", { class: trackClass })), inlineMessage && (index.h("div", { class: "inline-message" }, index.h("hmc-message", { status: status }, inlineMessage))))));
  }
  get el() { return index.getElement(this); }
};
HmcProgressBar.style = progressBarCss;

exports.hmc_progress_bar = HmcProgressBar;
