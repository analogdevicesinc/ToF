...
const HmcRadioGroup = class {
  constructor(hostRef) {
    ...
    this.radioChanged = index.createEvent(this, "radioChanged", 7);
    this.onClick = (ev) => {
      ev.preventDefault();
  ...
  render() {
    utils.renderHiddenInput(this.el, this.name, false, this.value);
    return (index.h(index.Host, { role: "radiogroup", onClick: this.onClick }, index.h("slot", null)));
  }
  setActiveItem(value) {
...
exports.hmc_radio_group = HmcRadioGroup;
