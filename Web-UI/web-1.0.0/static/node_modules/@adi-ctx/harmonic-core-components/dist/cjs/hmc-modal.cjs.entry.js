...
const HmcModal = class {
  constructor(hostRef) {
    ...
    this.modalCloseRequest = index.createEvent(this, "modalCloseRequest", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("hmc-modal-overlay", { isOpen: isOpen }, index.h("a", { id: "start-trap", href: "javascript:void 0", role: "navigation", ref: el => (this._startTrapRef = el), onFocusin: ev => this.wrapFocus(ev, this._endTrapRef) }), index.h("div", { class: rootClass, role: "dialog", "aria-modal": "true", "aria-label": label }, index.h("div", { class: "p-x" }, index.h("div", { class: "modal-header" }, hasHeader && index.h("slot", { name: "modal-header" }), index.h("hmc-button", { class: "close-icon", kind: "ghost", size: "sm", "icon-only": true, onClick: () => this.handleModalClose() }, index.h("hmc-icon", { name: "close-m" })))), index.h("div", { class: "modal-content" }, index.h("slot", null)), hasFooter && (index.h("div", { class: "p-x" }, index.h("div", { class: "modal-footer" }, index.h("slot", { name: "modal-footer" }))))), index.h("a", { id: "end-trap", href: "javascript:void 0", role: "navigation", ref: el => (this._endTrapRef = el), onFocusin: ev => this.wrapFocus(ev, this._startTrapRef) }))));
  }
