...
const HmcBannerMessage = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.actionClicked = index.createEvent(this, "actionClicked", 7);
    this.bannerCloseRequested = index.createEvent(this, "bannerCloseRequested", 7);
    this.status = 'info';
    this.density = 'low';
    this.actionText = '';
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: classList }, index.h("div", { class: "content-container" }, withIcon && index.h("hmc-icon", { name: icon }), index.h("div", { class: "main-content" }, index.h("slot", null))), index.h("div", { class: "action-container" }, actionText !== '' && (index.h("hmc-button", { size: density === 'low' ? 'sm' : 'xs', kind: "secondary", onClick: () => this.actionClicked.emit() }, actionText)), isClosable && (index.h("hmc-button", { "icon-only": true, size: density === 'low' ? 'sm' : 'xs', kind: "ghost", onClick: () => this.bannerCloseRequested.emit() }, index.h("hmc-icon", { name: "close-m" })))))));
  }
};
HmcBannerMessage.style = bannerMessageCss;

exports.hmc_banner_message = HmcBannerMessage;
