...
const HmcDropdownGroup = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "group" }, index.h("div", { class: classes, id: this.groupTitle ? 'group-title' : undefined }, !this.isFirstElement && index.h("div", { class: "divider" }), this.groupTitle && index.h("div", { class: "title" }, this.groupTitle), index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
};
HmcDropdownGroup.style = dropdownGroupCss;

exports.hmc_dropdown_group = HmcDropdownGroup;
