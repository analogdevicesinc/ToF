...
#ifndef SWIG
static const enum spiBitRates bitRate_map[] = { SPI_BIT_RATE_1M, SPI_BIT_RATE_2M, SPI_BIT_RATE_4M, SPI_BIT_RATE_8M, SPI_BIT_RATE_12M, SPI_BIT_RATE_16M };
#endif
...
#ifndef SWIG
/**
 * @brief Transfer bytes over the SPI Interface
 *
...
/**
 * @brief Write a 32-bit word to the Newton over the SPI Interface
 *
 * @param bytes_out the number of bytes to be sent over the SPI interface to the Newton.
 * @param data_out the data to be sent over the SPI interface to the Newton.
 * @param bytes_in the number of bytes to be recevied from the Newton over the SPI interface.
...
/**
 * @brief Write multiple 16-bit words to the Newton over the SPI Interface
 *
 * @param address the address of the data to be written.
 * @param dataLength the number of words to be written.
 * @param dataPtr a pointer to the data written to the Newton.
 * @return status value. Indicates success or failure of the function.
 *
 */
...
/**
 * @brief Read multiple 16-bit words from the Newton over the SPI Interface
 *
 * @param address the address of the data to be read.
 * @param dataLength the number of words to be read.
 * @param dataPtr a pointer to the data read from the Newton.
 * @return status value. Indicates success or failure of the function.
 *
 */
 ...
 *
 * @param bitRate the bit rate that the SPI interface should operate at.
 * @return status value. Indicates success or failure of the function.
 *
 */
...
/**
 * @brief Test if the SPI Device is open.
 *
 * @return status value. Indicates success or failure of the function.
 *
 */
...
/**
 * @brief WWait for H2S Valid from HSP.
 * 
...
/**
 * @brief Wait for S2H not valid from HSP.
 * 
...
/**
 * @brief Send data to HSP.
 * 
 * This task sends the data to the HSP.
 *
 * @param wr_data Write Data Array.
 * @param word_count Word Count.
 * @return status value. Indicates success or failure of the function.
 *
 */
...
/**
 * @brief Send write register list
 * Send data to HSP.
 * 
 * This function sends the register write list to the HSP.
 *
 * @param wr_addr Address Array.
 * @param wr_data Data Array.
 * @param word_count Word Count.
 * @return status value. Indicates success or failure of the function.
 */
...
/**
 * @brief Send read register list
 * Send data to HSP.
 * 
 * This task sends the register read list to the HSP.
 *
 * @param rd_addr Address Array.
 * @param word_count Word Count.
 * @return status value. Indicates success or failure of the function.
 */
...
/**
 * @brief Get data from HSP.
 * 
 * This task gets read data from HSP.
 *
 * @param word_count Word Count.
 * @param rd_data Read Data Array.
 * @return status value. Indicates success or failure of the function.
 *
 */
 ...
 * @param data32 a pointer to the data read from the Newton.
 * @return status value. Indicates success or failure of the function.
 *
 */
...
/**
 * @brief Perform write burst through HSP with incrementing addresses.
 * 
...
/**
 * @brief Write list of registers.
 *
 * @param wr_addr Write Address.
 * @param burst_size Number of words to transfer.
 * @param wr_data Write Data.
 * @return status value. Indicates success or failure of the function.
 */
...
/**
 * @brief Read register list.
 * 
 * @param rd_addr List of read addresses.
 * @param burst_size Number of words to transfer.
 * @param rd_data Write Data.
 * @param slave_id Slave ID. This argument may be omitted and defaults to zero.
 * @return status value. Indicates success or failure of the function.
 */
int adi_read_register_list( u16 *rd_addr, int burst_size, u16 *rd_data );

/**
 * @brief Perform read burst through HSP with incrementing addresses.
 * 
