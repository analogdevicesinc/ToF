...
/* ================================================================================
     ...
     Project     :   hsp_regs
     File        :   hsp_regs_addr_bdef.h
     Description :   C header file contains macros for bit-field reference access functions.
...
#ifndef HSP_REGS_ADDR_BDEF_H
#define HSP_REGS_ADDR_BDEF_H
