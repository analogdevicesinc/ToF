...
""" Script generated from simulation of the fc_asm_mscm_adc_test test case.


Usage:
    fc_asm_mscm_adc_test.py [--no_fw_load][--no_reset]
...
if __name__ == "__main__":
   ...
   if loadFirmware == True:
      cmd_file = os.path.expanduser( "./tests/dms_eval_tests/fc_asm_mscm_adc_test/fc_asm_mscm_adc_test.txt" )
   ...
   newton.adi_check_register_py( 0x0032, 0x0000 ) # errorStatus
   newton.adi_check_register_py( 0x0256, 0x0002 ) # SCRATCHPAD[43]
   newton.adi_write_register( 0x0146, 0x0040 ) # power_down_adc_others
