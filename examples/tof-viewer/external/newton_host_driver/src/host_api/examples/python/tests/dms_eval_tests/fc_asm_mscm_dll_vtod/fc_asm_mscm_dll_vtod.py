...
""" Script generated from simulation of the fc_asm_mscm_dll_vtod test case.


Usage:
    fc_asm_mscm_dll_vtod.py [--no_fw_load][--no_reset]
...
if __name__ == "__main__":
   ...
   if loadFirmware == True:
      cmd_file = os.path.expanduser( "./tests/dms_eval_tests/fc_asm_mscm_dll_vtod/fc_asm_mscm_dll_vtod.txt" )
   ...
   newton.adi_write_register( 0x011e, 0x0007 ) # clktree0
   newton.adi_check_register_py( 0x0032, 0x0000 ) # errorStatus
   newton.adi_check_register_py( 0x0034, 0x0004 ) # gpioCtrl
   newton.adi_write_register( 0x0034, 0x0000 ) # gpioCtrl
   newton.adi_write_register( 0x0160, 0x0019 ) # ana_test_mux_s1
   newton.adi_write_register( 0x0150, 0x010d ) # regif_ctrl
   newton.adi_check_register_py( 0x0032, 0x0000 ) # errorStatus
   newton.adi_check_register_py( 0x0150, 0x0101 ) # regif_ctrl
   newton.adi_check_register_py( 0x0032, 0x0000 ) # errorStatus
   newton.adi_check_register_py( 0x0160, 0x0019 ) # ana_test_mux_s1
