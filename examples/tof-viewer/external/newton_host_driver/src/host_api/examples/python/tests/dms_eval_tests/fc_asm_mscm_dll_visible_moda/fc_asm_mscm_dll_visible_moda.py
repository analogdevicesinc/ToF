...
""" Script generated from simulation of the fc_asm_mscm_dll_visible_moda test case.


Usage:
    fc_asm_mscm_dll_visible_moda.py [--no_fw_load][--no_reset]
...
if __name__ == "__main__":
   ...
   if loadFirmware == True:
      cmd_file = os.path.expanduser( "./tests/dms_eval_tests/fc_asm_mscm_dll_visible_moda/fc_asm_mscm_dll_visible_moda.txt" )
