...
""" Script generated from simulation of the fc_asm_mscm_dll_lock_range_dutycycle_5p2ns_200Mhz test case.


Usage:
    fc_asm_mscm_dll_lock_range_dutycycle_5p2ns_200Mhz.py [--no_fw_load][--no_reset]
...
if __name__ == "__main__":
   ...
   if loadFirmware == True:
      cmd_file = os.path.expanduser( "./tests/dms_eval_tests/fc_asm_mscm_dll_lock_range_dutycycle_5p2ns_200Mhz/fc_asm_mscm_dll_lock_range_dutycycle_5p2ns_200Mhz.txt" )
   ...
   newton.adi_check_register_py( 0x0034, 0x0004 ) # gpioCtrl
   newton.adi_write_register( 0x0034, 0x0000 ) # gpioCtrl
   newton.adi_write_register( 0x0122, 0x0200 ) # clktree_s1
   newton.adi_write_register( 0x0150, 0x010d ) # regif_ctrl
   newton.adi_check_register_py( 0x0032, 0x0000 ) # errorStatus
   newton.adi_check_register_py( 0x0150, 0x0101 ) # regif_ctrl
   newton.adi_write_register( 0x0138, 0x0035 ) # lsctrl0_s1
