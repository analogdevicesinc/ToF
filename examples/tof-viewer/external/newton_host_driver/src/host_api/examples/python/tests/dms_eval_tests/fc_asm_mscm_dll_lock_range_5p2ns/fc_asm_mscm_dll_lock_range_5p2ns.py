...
""" Script generated from simulation of the fc_asm_mscm_dll_lock_range_5p2ns test case.


Usage:
    fc_asm_mscm_dll_lock_range_5p2ns.py [--no_fw_load][--no_reset]
...
if __name__ == "__main__":
   ...
   if loadFirmware == True:
      cmd_file = os.path.expanduser( "./tests/dms_eval_tests/fc_asm_mscm_dll_lock_range_5p2ns/fc_asm_mscm_dll_lock_range_5p2ns.txt" )
