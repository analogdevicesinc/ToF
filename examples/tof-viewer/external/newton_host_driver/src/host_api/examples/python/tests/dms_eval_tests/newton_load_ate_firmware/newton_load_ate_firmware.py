...
""" Script generated from simulation of the newton_load_ate_firmware test case.


Usage:
    newton_load_ate_firmware.py [--no_fw_load][--no_reset]
...
if __name__ == "__main__":
   ...
   if loadFirmware == True:
      cmd_file = os.path.expanduser( "./tests/dms_eval_tests/newton_load_ate_firmware/newton_load_ate_firmware.txt" )
