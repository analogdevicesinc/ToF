...
    -> Open WinScp 
    -> Host Name (or IP Address) : 192.168.56.1
...
        - Firmware_update_utilities
    ...
    -> Copy the directory from Host PC to NXP Host. (Alternate method instead of Winscp)
        ...
        $ pscp -P 22 -l analog -pw analog -r Firmware_update_utilities analog@192.168.56.1:/home/analog/Workspace

2). SSH into NXP platform
    -> SSH with Putty example
    -> Host Name (or IP Address) : 192.168.56.1 ; Port 22 ; SSH
    -> NXP Username : analog
           Password : analog
