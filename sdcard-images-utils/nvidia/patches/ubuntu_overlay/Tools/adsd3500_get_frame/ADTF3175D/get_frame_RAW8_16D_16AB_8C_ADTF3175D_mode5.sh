...
v4l2-ctl --set-ctrl=operating_mode=5 -d /dev/v4l-subdev1
...
v4l2-ctl --device /dev/video0 --set-fmt-video=width=2560,height=512,pixelformat=RGGB --stream-mmap --stream-to=mode5.bin --stream-count=$nr_frames
