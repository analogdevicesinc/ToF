...
sudo DOCKER_BUILDKIT=1 docker build --file ubuntu_18_04/crosby/Dockerfile --output crosby/out_ubuntu18 .
...
echo "Generating dpkg for Ubuntu 18.04 Amd64"
sudo DOCKER_BUILDKIT=1 docker build --file ubuntu_18_04/adsd3030/Dockerfile --output adsd3030/out_ubuntu18 .
echo "Generating dpkg for Ubuntu 20.04 Amd64"
